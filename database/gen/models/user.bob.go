...
func buildUserColumns(alias string) userColumns {
	return userColumns{
		...
		PasswordDigest: sqlite.Quote(alias, "password_digest"),
	}
}
...
type userColumns struct {
	...
	PasswordDigest sqlite.Expression
}
...
func (s UserSetter) SetColumns() []string {
	...
	if s.PasswordDigest != nil {
		vals = append(vals, "password_digest")
	}
	return vals
}
...
func (s UserSetter) Overwrite(t *User) {
	...
	if s.PasswordDigest != nil {
		t.PasswordDigest = func() string {
			if s.PasswordDigest == nil {
				return *new(string)
			}
			return *s.PasswordDigest
		}()
	}
}
...
func (s UserSetter) Expressions(prefix ...string) []bob.Expression {
	...
	if s.PasswordDigest != nil {
		exprs = append(exprs, expr.Join{Sep: " = ", Exprs: []bob.Expression{
			sqlite.Quote(append(prefix, "password_digest")...),
			sqlite.Arg(s.PasswordDigest),
		}})
	}
...
type userWhere[Q sqlite.Filterable] struct {
	...
	PasswordDigest sqlite.WhereMod[Q, string]
}
...
func buildUserWhere[Q sqlite.Filterable](cols userColumns) userWhere[Q] {
	return userWhere[Q]{
		...
		PasswordDigest: sqlite.Where[Q, string](cols.PasswordDigest),
	}
}
